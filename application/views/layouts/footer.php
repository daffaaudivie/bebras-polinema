            ...
            <div class="row">
                ...
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <div class="d-flex align-items-center mb-3">
                        <img src="<?php echo base_url('assets/images/polinema.png'); ?>" alt="Polinema" class="footer-logo me-2" style="width: 40px;">
                        <img src="<?php echo base_url('assets/images/bebras-indonesia.png'); ?>" alt="Bebras Indonesia" class="footer-logo" style="width: 120px;">
                    </div>
                ...
                <div class="col-lg-3 mb-4 mb-lg-0">
                    ...
                    <div class="contact-info">
                        ...
                        <p class="text-muted small mb-1">URL: http://bebras.or.id</p>
                        </p>
                    </div>
                </div>
